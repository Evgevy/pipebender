...
var mySwiper2Prev = document.querySelector('.swiper-button-prev-two');
var mySwiper2Next = document.querySelector('.swiper-button-next-two');
var main = new Swiper('.buy__slider', {
  slidesPerView: 2,
  spaceBetween: 20,
  observer: true,
  observeParents: true,
...
document.addEventListener('DOMContentLoaded', function () {
  var myBtns = document.querySelectorAll('.pipe-machines__page-link');
  myBtns.forEach(function (btn) {
    btn.addEventListener('click', function () {
      myBtns.forEach(function (b) {
        return b.classList.remove('pipe-machines__page-link--active');
      });
